...
- **📜 历史上的今天**：今日卡内可折叠小节，按日期内联展示约 **3 条大事记 + 4~6 位精选名人诞辰**（历史名人为先）；**折叠态默认直接露出首条**（点击即可展开），右侧「展开全部 N 条 ▾ / 收起 ▴」为明显的胶囊按钮；内置 **366 天离线快照**（含 2/29，大陆裸网环境也完整可用），网络可达中文维基时自动增强当日最新内容（12h 缓存），来源标注 CC BY-SA
